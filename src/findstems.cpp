...
int main (int argc, char *argv[])
{
	...
	{
		std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> tmpregions;
	...
	std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cyls;
	nnearest = 60;
	...
	std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> pca;
	...
	std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> stems;
	stems = pca;
